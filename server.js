...
(function() {
  var MongoStore, app, async, browserCheck, chbs, cleans, colors, connect, curses, cussFilter, ensureSession, express, fs, io, isValidEmailAddress, mailer, models, online, os, package_info, pwh, secrets, sessionStore, smtp, socketio, uuid, validateHID, _,
  ...
  app.get("/what", browserCheck, function(req, res) {
    return res.render("what", {
      appmode: req.session.person
    });
  });

  app.get("/who", browserCheck, function(req, res) {
    return res.render("who", {
      appmode: req.session.person
    });
  });

  app.get("/up", browserCheck, function(req, res) {
    if (req.session.person) {
      return res.redirect("/lounge");
    } else {
  ...
  app.get("/in", browserCheck, function(req, res) {
